...
?>
<style>
.main-container{ padding-top: 86px; padding-bottom: 80px; background: url('http://img03.taobaocdn.com/tps/i3/T1YXWgFcVbXXcCXlfb-25-25.png') repeat; }
.main-container .inner{ width:1000px; margin:0px auto; }
.main-container .inner .sel-type{ display: block; width:185px; height: 35px; background:#666; color:#fff; text-decoration: none; font-family: Microsoft Yahei; font-size: 14px; text-decoration: center; }
.main-container .inner .sel-type span.cur{ float: left; display: block; height: 35px; width: 96px; text-align: center; line-height: 35px; }
.main-container .inner .sel-type i.arrow{ display: block; overflow: hidden; float: left; height: 35px; width:44px; background: url('http://img02.taobaocdn.com/tps/i2/T1Kp5fFjJdXXbiP06j-56-16.png') no-repeat 13px 10px; }
.main-container .inner .sel-content{display: none;}
.main-container .inner .sel-content-inner{ padding: 16px 28px; }
.main-container .inner .sel-content-inner ul li{margin-right: 6px;}
.main-container .inner .sel-content-inner ul li,.main-container .inner .sel-content-inner ul li a{ width:80px; height: 80px; display: block; float: left; }
...
<div class="main-container">
	...
	<iframe id="J_Frame" name="J_Frame" class="gen-inframe" scrolling="no" frameborder="0" src="generator/linechart.html"></iframe>
	</div>
</div>
