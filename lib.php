	...
	<div class="inner clearfix">
		...
		<div class="sidercontent">
			...
			<div class="btn-container">
				<a class="btn-gen" href="generator.php">生成demo及代码</a>
				<a class="btn-doc" target="_blank" href="http://gallery.kissyui.com/kcharts/1.1/guide/index.html?spm=0.0.0.0.WpVybg">查看文档</a>
			</div>
		</div>
	</div>
</div>
